...
|---------|---------------------------|
| Handoff | `./workflow handoff --from <id> --to <id> [--artifacts <csv>] [--notes <text>]` |
...
from agentic_workflow.generators.session import generate_active_session

# Generate documentation
cli_content = generate_cli_reference(workflow_package)
pipeline_content = generate_agent_pipeline(workflow_package)
```
